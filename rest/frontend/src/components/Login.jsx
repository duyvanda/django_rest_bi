...
return (
    <div className="container">
        ...
        <form style={{ display: "inline-block" }} onSubmit={handleSubmit}>
            ...
            <input className="form-control" onChange={handleTextChange} defaultValue={email} type="email" placeholder="Enter Ma NV" style={{ background: "#f7f7f9", fontFamily: "Arial", border: "none" }}></input>

...
export function MdsTraThuongCmmQ12025L1() {
    ...
    useEffect(() => {
        ...
        userLogger(JSON.parse(localStorage.getItem("userInfo")).manv, 'mds_tra_thuong_cmm_q12025_l1', isMB, dv_width);
    ...
    <Container className="bg-teal-100 h-100" fluid>
        ...
        <Row>
                    ...
                    <h1 className="ms-auto" style={{ textAlign: 'justify' }} >TRẢ THƯỞNG CMM 2025 - L1</h1>

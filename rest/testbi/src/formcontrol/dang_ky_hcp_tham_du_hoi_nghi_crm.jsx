...
function Dang_ky_hcp_tham_du_hoi_nghi_crm({history}) {
    ...
    const fetch_tracking_chi_phi_get_data_hcp = async (manv) => {
        SetLoading(true);
        const response = await fetch(`https://bi.meraplion.com/local/get_data/get_dang_ky_hcp_tham_du_hoi_nghi_crm/?manv=${manv}`)
        
        if (response.ok) {
        SetLoading(false);
        const data = await response.json()
        set_arr_hcp(data['lst_hcp_dang_ky']);
        set_sl_da_chon(data['lst_hcp_dang_ky'].length)
    ...
    const post_form_data = async (data) => {
        ...
        const response = await fetch(`https://bi.meraplion.com/local/post_data/insert_dang_ky_hcp_tham_du_hoi_nghi_crm/`, {
            method: "POST",
            headers: {
...
export default Dang_ky_hcp_tham_du_hoi_nghi_crm
...
function Tracking_chi_phi_hco({history}) {
    ...
    const handle_submit = (e) => {
        ...
        const data = {
            ...
            "gia_tri_smn": gia_tri_smn === "" ? "0": gia_tri_smn,
            "chon_thang_sms":chon_thang_sms,
            "gia_tri_sms":gia_tri_sms === "" ? "0": gia_tri_sms,
            ...
            <Row className="justify-content-center">
                <Col md={5} >
                    ...
                    <div>
                        ...
                        <Form.Select className="mt-2" style={{height:"60px"}} onChange={ (e) => set_chon_loai_ttk(e.target.value)  }>                                 
                        ...
                        <Button disabled={
                            hco === "" |
                            Number(gia_tri_smn)+Number(gia_tri_sms)+Number(gia_tri_ttk)<=0 |
                            (Number(gia_tri_smn) > 0 && chon_thang_smn === ""  ) |
                            (Number(gia_tri_smn) > 0 && chon_khoa_phong_smn === "" ) |
                            (Number(gia_tri_sms) > 0 && chon_thang_sms === "") |
                            (Number(gia_tri_ttk) > 0 && chon_thang_ttk === "" ) |
                            (Number(gia_tri_ttk) > 0 && chon_loai_ttk === "")
...
export default Tracking_chi_phi_hco
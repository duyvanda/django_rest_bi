...
function Maps() {
  const { map, fetchMaps, loading } = useContext(MapContext);
  ...
  return (
    <div>
      <Form className="d-flex ml-5 mt-2" onSubmit={handleMapsSubmit}>
        <Form.Group>
          <Form.Control
            type="text"
            disabled={true}
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            placeholder="FromDate: 01-06-2023"
          ></Form.Control>
        </Form.Group>
